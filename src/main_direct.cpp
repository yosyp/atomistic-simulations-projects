 ...
 * @date 27 Jan 2018
 * @brief An example of code with manual building the simulation setup (using MSE6270_MD as a library), without loading
 *configuration from "md.rc". The following example generates an identical setup to one obtained from md.input file,
 *provided for Homework #3. After modifying this file, recompile your code. This method provides more flexibility and
 *may be useful for your projects. */
...
int main() {
  ...
  // system.potentials[0]->print();								//print (type1-type1) interaction potential; check "print"
  // in "Potentials.cpp" for more details
