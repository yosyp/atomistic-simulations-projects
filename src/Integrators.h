...
namespace MSE6270_MD {
	...
	public:
		...
		virtual void pre_step();									//!< Perform a pre step of integration (before force calculation) used in some integration algorithms like predictor-corrector
	...
	/*! This class implements 5-th order Predictor-Corrector algorithm.
		See [Nordsieck A., Math.Comput.16, 22, 1962], p. 154 in [C. William Gear, Numerical initial value problems in ordinary differential equations, 
		Prentice-Hall Inc., Englewood Cliffs, NJ, 1971], and [Allen & Tildesley, p.340] for more details */
